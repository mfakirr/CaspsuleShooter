...
public class GameManager : MonoBehaviour {
	...
	public Text mainHighScoreDisplay;
	...
	void Start () {
		...
		//
		if (mainHighScoreDisplay != null)
			mainHighScoreDisplay.text = "";
	...
	void HighScoreCal()
    {
		...
		mainHighScoreDisplay.text = "High Score = " + HighScore;
	}
